...
## Project Structure
    ...
    ├── testsjdbsbcbedcde_d_53142  # Django project configurations
...
1. Clone this repo and `cd testsjdbsbcbedcde_d_53142`
...
2. Clone this repo and `cd testsjdbsbcbedcde_d_53142`
